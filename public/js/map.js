...
export async function refreshMap() {
  ...
  data.letters.forEach(letter => {
    ...
    if (letter.is_authored_by_you) {
      ...
      popupHtml = `<b>${escapeHtml(letter.title || 'Untitled')}</b><br>${letter.hands_count} hands · traveling ${letter.traveling_days}d<br><button onclick="readLetter('${letter.id}', false)">Read</button>`;
